...
export default class Toolbar {
  constructor(data) {
    ...
    this.btnChildren = [
      ...
      buildDivider(),
      this.boldEl = buildButtonWithIcon('Bold (Ctrl+B)', 'bold', () => toggleChange.call(this, 'bold', 'font-bold')),
      this.italicEl = buildButtonWithIcon('Italic (Ctrl+I)', 'italic', () => toggleChange.call(this, 'italic', 'font-italic')),
